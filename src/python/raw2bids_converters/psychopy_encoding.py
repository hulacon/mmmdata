...
SIDECAR = {
    ...
    "movie_title.started": {
        "Description": "Onset of the movie_title routine relative to scanner start (wait.started; title events only)",
        "Units": "s",
    },
    "movie_title.stopped": {
        "Description": "Offset of the movie_title routine relative to scanner start (wait.started; title events only)",
        "Units": "s",
    },
}
