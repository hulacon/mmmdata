...
def _ensure_registered() -> None:
    ...
    register_step(StepSpec(
        ...
        description="Per-session QC decisions TSV (human-reviewable stub).",
        depends_on=("fmriprep_nordic",),  # tracks the NORDIC pipeline by default
        variants=("original", "nordic"),
