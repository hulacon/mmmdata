...
SIDECAR = {
    ...
    "recall1.started": {
        "Description": "Onset of the recall1 routine relative to scanner start (recall events only)",
        "Units": "s",
    },
    "recall1.stopped": {
        "Description": "Offset of the recall1 routine relative to scanner start (recall events only)",
        "Units": "s",
    },
}
